...
/* The B&B monogram from baidas.ch (app/icon.svg), in brand navy. */
export const Monogram = ({ size = 26 }) => (
  <svg viewBox="31.5 0.75 37 37" width={size} height={size} aria-hidden="true">
    <g fill="#0E1B2A" stroke="#0E1B2A" strokeWidth="1.1" strokeLinejoin="round">
